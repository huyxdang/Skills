...
interface ParsedReviewThread {
  readonly id: string;
  readonly firstComment: T.ReviewComment | null;
  readonly resolved: boolean;
}

export function parseReviewThreadPage(value: unknown): {
...
function finalizeReviewThreads(threads: readonly ParsedReviewThread[]): readonly T.ReviewThread[] {
